  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_range_end: "day-range-end !text-white !bg-[#ff5a0a] rounded-full",
        day_range_start: "day-range-end !text-white !bg-[#ff5a0a] rounded-full",
        ...
        day_range_middle: "text-orange-500 !bg-[#ffe7dc] rounded-none",
